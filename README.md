...
## 11. How this maps to real-world resume points

This project was built to genuinely back up claims like:

> *"Built a React-based custom video player with advanced features
> including adaptive bitrate streaming (ImageKit ABS), quality switching,
> chapters, subtitles, and playback speed controls."*
— see `src/hooks/useHls.js`, `src/components/{Controls,QualitySelector,
ChapterList,SubtitleMenu}.jsx`.

> *"Integrated ImageKit Adaptive Bitrate Streaming (ABS) to deliver
> optimized playback quality depending on user network conditions."*
— see §4 above and `src/utils/imagekit.js` + `useHls.js`'s ABR/error-recovery
handling.

> *"Designed and implemented intuitive UI controls for chapter
> navigation, playback speed adjustment, and quality toggling. Enhanced
> accessibility through subtitle and closed-caption support."*
— see `ChapterList.jsx`, the speed menu in `Controls.jsx`,
`QualitySelector.jsx`, and `SubtitleMenu.jsx`, all with ARIA roles.

> *"Optimized video playback performance for cross-browser compatibility
> and responsive layouts on desktop and mobile."*
— see §8 above and the responsive breakpoints throughout `src/styles/`.

---

## 12. License

Provided as a learning/portfolio reference implementation. Swap in your
own ImageKit account, video assets, and branding freely.
